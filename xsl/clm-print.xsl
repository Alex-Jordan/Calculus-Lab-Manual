...
<xsl:param name="latex.preamble.early" select="document('print.preamble.xml')//latex-preamble-early" />
<xsl:param name="latex.preamble.late" select="document('print.preamble.xml')//latex-preamble-late" />
