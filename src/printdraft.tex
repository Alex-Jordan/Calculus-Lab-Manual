...
%
\typeout{************************************************}
\typeout{Activity .1 Answers to Supplemental Exercises}
\typeout{************************************************}
...
\noindent\textbf{18.}\quad{}
                ...
                \par\smallskip
\noindent\textbf{19.}\quad{}
                    \(y=\frac{7}{32}\left(x-1\right)+\frac{5}{8}\)%
...
\noindent\textbf{40.}\quad{}
                ...
                \par\smallskip
\noindent\textbf{41.}\quad{}
                    \(\ointerval{-3}{-1}\), \(\ointerval{1}{4}\), and \(\ointerval{4}{6}\)%
