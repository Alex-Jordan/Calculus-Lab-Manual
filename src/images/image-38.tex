...
%
    ...
    \begin{document}
                        ...
                        \begin{tikzpicture}
                        \begin{axis}[width=0.75\textwidth,xmin=-1,xmax=10,ymin=-1,ymax=10,xtick={-1,0,...,10}, minor xtick={-1,-0.5,...,10},ytick={0,1,...,10}, minor ytick={-1,-0.5,...,10},grid=major,samples=100]
                            \addplot+[
                                domain=-0.1:8.25,
                                <->,
